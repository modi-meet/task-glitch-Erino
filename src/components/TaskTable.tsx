            ...
            <TableBody>
              {tasks.map(t => (
                <TableRow key={t.id} hover onClick={() => setDetails(t)} sx={{ cursor: 'pointer' }}>
                  ...
                  <TableCell align="right">{t.roi == null || !Number.isFinite(t.roi) ? 'N/A' : t.roi.toFixed(2)}</TableCell>
                  ...
                  <TableCell align="right">
                    <Stack direction="row" spacing={1} justifyContent="flex-end">
                      ...
                      <Tooltip title="Delete">
                        <IconButton onClick={(e) => { e.stopPropagation(); onDelete(t.id); }} size="small" color="error" aria-label="Delete">
